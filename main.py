...
async def start_command(message: types.Message):
    ...
    await message.answer("👋 Γεια σου! Στείλε /remind αριθμός μονάδα χρόνου μήνυμα για να αποθηκεύσεις μια υπενθύμιση. Π.χ. /remind 2 ώρες Να πάρω τηλέφωνο. Επίσης αν χρειαστείς Ηλία να διαγράψεις μία υπενθύμιση πληκτρολόγησε delete_reminder και τον αριθμό του ID της υπενθύμισης")
